...
export const padHex = (bigInteger: BigInteger | string) => {
...
export const computehkdf = (ikm: WordArray | string, salt: WordArray | string): WordArray => {
...
export const computeSignature = (message: WordArray, key: WordArray): string => {
