...
import { debugType, IDebugLogDocument } from './interfaces/IDebugLogDocument';
import { IErrorLogDocument, typeSeverity } from './interfaces/IErrorLogDocument';
import { IDebugMeta, ILogMeta, ITransactionId } from './interfaces/ILogDocument';
